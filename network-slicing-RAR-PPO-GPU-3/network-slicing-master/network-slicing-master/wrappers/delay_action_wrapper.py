...
class DelayActionWrapper(gym.Wrapper):
    ...
    def _build_default_action(self) -> np.ndarray:
        ...
        elif hasattr(self.env, "node_b") and hasattr(self.env.node_b, "n_slices_l1"):
            n_slices = int(self.env.node_b.n_slices_l1)
        else:
        ...
        elif hasattr(self.env, "node_b") and hasattr(self.env.node_b, "n_prbs"):
            n_prbs = int(self.env.node_b.n_prbs)
        else:
            n_prbs = 0
